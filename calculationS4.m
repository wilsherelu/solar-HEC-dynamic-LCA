...
for i=2:size(Cprediction,3)%size(Cprediction,3)
    ...
    NSghg(:,i)=(SolarGHGM+SolarE*NSghg(:,i-1))./(lifespan*365*Solardaily);
    if i<=20
...
% xlswrite('C:\Users\lu\Desktop\job\ECfuture\s2s.xlsx',NatAvg,'NatAvg','A1');
% xlswrite('C:\Users\lu\Desktop\job\ECfuture\s2s.xlsx',avgsolar,'SolarAvg','A1');
% xlswrite('C:\Users\lu\Desktop\job\ECfuture\s2s.xlsx',NSghg,'SolarNew','A1');
% xlswrite('C:\Users\lu\Desktop\job\ECfuture\s2s.xlsx',Eghg,'State','A1');